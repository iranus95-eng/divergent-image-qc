...
const STYLE_ID='billing-original-logo-style-v3';
function installStyle(){
  if(document.getElementById(STYLE_ID))return;
  const s=document.createElement('style');
  s.id=STYLE_ID;
  s.textContent=`
#billingPaper>.bi-logo-svg,#billingPaper>.bi-logo{display:none!important}
#billingPaper>.bi-logo-original{position:absolute!important;left:24px!important;top:24px!important;width:183px!important;height:61px!important;max-width:none!important;max-height:none!important;object-fit:contain!important;display:block!important;z-index:30!important}
`;
...
function apply(scope=document){
  ...
  if(!paper)return;
  paper.querySelectorAll(':scope > .bi-logo-svg,:scope > .bi-logo').forEach(el=>{
